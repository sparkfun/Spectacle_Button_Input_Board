// ======================================================================
// Spectacle_Button_Input_Board.v generated from TopDesign.cysch
// 03/09/2017 at 16:01
...
module top ;
	...
	wire [0:0] tmpOE__B_0_net;
	wire [0:0] tmpFB_0__B_0_net;
	wire [0:0] tmpIO_0__B_0_net;
	wire [0:0] tmpINTERRUPT_0__B_0_net;
	electrical [0:0] tmpSIOVREF__B_0_net;

	cy_psoc3_pins_v1_10
		#(.id("2ac3b6ce-1188-4075-84c6-3b4cba08b64e"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		B_0
		 (.oe(tmpOE__B_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__B_0_net[0:0]}),
		  .io({tmpIO_0__B_0_net[0:0]}),
		  .siovref(tmpSIOVREF__B_0_net),
		  .interrupt({tmpINTERRUPT_0__B_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("ab51ea4b-ad55-4ce2-aeee-bee861920e71"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__B_1_net;
	wire [0:0] tmpFB_0__B_1_net;
	wire [0:0] tmpIO_0__B_1_net;
	wire [0:0] tmpINTERRUPT_0__B_1_net;
	electrical [0:0] tmpSIOVREF__B_1_net;

	cy_psoc3_pins_v1_10
		#(.id("631d30b7-0358-4c4f-aa00-28f32aa58872"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		B_1
		 (.oe(tmpOE__B_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__B_1_net[0:0]}),
		  .io({tmpIO_0__B_1_net[0:0]}),
		  .siovref(tmpSIOVREF__B_1_net),
		  .interrupt({tmpINTERRUPT_0__B_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__B_3_net;
	wire [0:0] tmpFB_0__B_3_net;
	wire [0:0] tmpIO_0__B_3_net;
	wire [0:0] tmpINTERRUPT_0__B_3_net;
	electrical [0:0] tmpSIOVREF__B_3_net;

	cy_psoc3_pins_v1_10
		#(.id("0a8cecc7-6461-4c58-b33c-83d7e82a1729"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		B_3
		 (.oe(tmpOE__B_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__B_3_net[0:0]}),
		  .io({tmpIO_0__B_3_net[0:0]}),
		  .siovref(tmpSIOVREF__B_3_net),
		  .interrupt({tmpINTERRUPT_0__B_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__B_4_net;
	wire [0:0] tmpFB_0__B_4_net;
	wire [0:0] tmpIO_0__B_4_net;
	wire [0:0] tmpINTERRUPT_0__B_4_net;
	electrical [0:0] tmpSIOVREF__B_4_net;

	cy_psoc3_pins_v1_10
		#(.id("4216b8b4-d078-48b7-91b3-024a21c895c8"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		B_4
		 (.oe(tmpOE__B_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__B_4_net[0:0]}),
		  .io({tmpIO_0__B_4_net[0:0]}),
		  .siovref(tmpSIOVREF__B_4_net),
		  .interrupt({tmpINTERRUPT_0__B_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__B_5_net;
	wire [0:0] tmpFB_0__B_5_net;
	wire [0:0] tmpIO_0__B_5_net;
	wire [0:0] tmpINTERRUPT_0__B_5_net;
	electrical [0:0] tmpSIOVREF__B_5_net;

	cy_psoc3_pins_v1_10
		#(.id("b4d53b98-59be-48ac-b221-701e1ab0dec2"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		B_5
		 (.oe(tmpOE__B_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__B_5_net[0:0]}),
		  .io({tmpIO_0__B_5_net[0:0]}),
		  .siovref(tmpSIOVREF__B_5_net),
		  .interrupt({tmpINTERRUPT_0__B_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__B_6_net;
	wire [0:0] tmpFB_0__B_6_net;
	wire [0:0] tmpIO_0__B_6_net;
	wire [0:0] tmpINTERRUPT_0__B_6_net;
	electrical [0:0] tmpSIOVREF__B_6_net;

	cy_psoc3_pins_v1_10
		#(.id("c220f2e7-c3b0-4e2a-8187-14f92f69f38d"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		B_6
		 (.oe(tmpOE__B_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__B_6_net[0:0]}),
		  .io({tmpIO_0__B_6_net[0:0]}),
		  .siovref(tmpSIOVREF__B_6_net),
		  .interrupt({tmpINTERRUPT_0__B_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__B_7_net;
	wire [0:0] tmpFB_0__B_7_net;
	wire [0:0] tmpIO_0__B_7_net;
	wire [0:0] tmpINTERRUPT_0__B_7_net;
	electrical [0:0] tmpSIOVREF__B_7_net;

	cy_psoc3_pins_v1_10
		#(.id("f38e7e9d-bc21-4341-8c67-0c268ff7a292"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		B_7
		 (.oe(tmpOE__B_7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__B_7_net[0:0]}),
		  .io({tmpIO_0__B_7_net[0:0]}),
		  .siovref(tmpSIOVREF__B_7_net),
		  .interrupt({tmpINTERRUPT_0__B_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__B_8_net;
	wire [0:0] tmpFB_0__B_8_net;
	wire [0:0] tmpIO_0__B_8_net;
	wire [0:0] tmpINTERRUPT_0__B_8_net;
	electrical [0:0] tmpSIOVREF__B_8_net;

	cy_psoc3_pins_v1_10
		#(.id("fb3b227a-0038-4855-ade2-7d42ebe87b0c"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		B_8
		 (.oe(tmpOE__B_8_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__B_8_net[0:0]}),
		  .io({tmpIO_0__B_8_net[0:0]}),
		  .siovref(tmpSIOVREF__B_8_net),
		  .interrupt({tmpINTERRUPT_0__B_8_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B_8_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
